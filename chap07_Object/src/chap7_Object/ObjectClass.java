...
public class ObjectClass {
	public static void main(String[] args) {
		...
		System.out.println(myStudent.name.equals(myStudent1.name));
		...
		Student s3 = new Student("놀부", 25, 5);
		...
		int x = 5;
		Box box4 = new Box();
		// 변수x를 넣어 값이 복사되어 들어가는지확인
		System.out.println(box4.plus(x));
		// 아래x 값이 바뀌지 않았으면 값이 복사되어 들어간것.
		...
		//정적변수를 이용한 상수
		//Box.MAX_BOX_LINE = 10; > final키워드로 수정할수 없다
